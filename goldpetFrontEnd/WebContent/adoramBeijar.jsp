    ...
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link " href="AjudeOng.jsp">Ajude-nos</a>
			...
			<div class="clearfix">
				...
				<p class="texto">Sabe aquela lambida no rosto que o seu
					cachorrinho adora dar? É o famoso beijo de cachorro. Normalmente um
					cão tem o costume de lamber a boca de outro animal, como sinal de
					afeição. É o mesmo carinho que a fêmea dispensa aos seus filhotes,
					lambendo-os para limpá-los e acarinhá-los. Já o filhote, lambe a
					boca da sua mãe para descobrir o que ela comeu e tentar pegar um
					restinho da alimentação que ficou no pelo.
				 	<br>
				No caso dos cães com o ser humano, também pode ser sinal de afeto, 
				mas um ótima forma de descobrir o que comemos.
				<br>
				Será que você entende tudo o que seu cachorro quer lhe dizer? Ao 
				prestar atenção em cada detalhe no comportamento do animal, 
				podemos minimizar problemas comportamentais e até descobrir problemas 
				clínicos logo no início.	
			   </p>
			   <br>
				<br>
				<br>
