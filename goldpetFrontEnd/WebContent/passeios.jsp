		...
		<div id="meio">
			...
			<div class="clearfix">
				...
				<p class="texto">Leve-o todos os dias para passear, o cachorro
					também precisa se exercitar e andar como nós, ainda mais se sua
					casa não tem quintal. Eles aproveitam o passeio para curtir sua
					companhia. Lembre-se que todo dono deve recolher as fezes de seu
					animalzinho nas ruas, praças e calçadas: é um ato de cidadania e
					obrigatório por lei.</p>
