...
<body>
	<div class="conteudo">
		...
		<div id="meio">
			...
			<br>
<div class="clearfix">
  <img class="img1" src="img/adoravel.jpg" alt="Adoravel" width="170px" height="170px">
  <h2><center>Adoram beijar</center></h2>
  Sabe aquela lambida no rosto que o seu cachorrinho adora dar? É o famoso beijo de cachorro. Normalmente um cão tem o costume de lamber a boca de...
  <br>
  <br>
  <br>
...
<br>
<div class="clearfix">
  <img class="img1" src="img/alimentacao.png" alt="Alimentacao" width="170px" height="170px">
  <h2><center>Alimentação</center></h2>
  Programe os horários de alimentar seu cão, sem excessos e de maneira razoável para que ele não passe fome...
  <br>
  <br>
  <br>
  <input type="button" value="Leia mais...">
...
<br>
<div class="clearfix">
  <img class="img1" src="img/snow.jpg" alt="Snow" width="170px" height="170px">
  <h2>Por que os cachorros fazem xixi em pé?</h2>
  A maioria dos machos tem esse tipo de comportamento, muito embora algumas fêmeas também. Muitos tutores...
  <br>
  <input type="button" value="Leia mais...">
  </div>
  <br>
  <div class="clearfix">
  <img class="img1" src="img/higiene.jpg" alt="Higiene" width="170px" height="170px">
